...
/****************************************************************************************************************
  Author        Roger Mähler
  Date          2017-09-11
  Issue         https://github.com/humlab-sead/sead_change_control/issues/168
                https://github.com/humlab-sead/sead_change_control/issues/150
  Description   Allow relation to multiple sample groups
  Prerequisites
  Reviewer
  Approver
  Idempotent    Yes
  Notes         20250206: This CR has been backported to SEAD_DATABASE_MODEL/tables.sql
                The reason for this is that the table is empty and the change history is not needed.
...
comment on table "public"."tbl_chronologies" IS '20170911PIB: 
    Removed Not Null requirement for sample-group_id to allow for chronologies not tied
    to a single sample group (e.e. calibrated ages for DataArc or other projects)
...
begin;
    ...
    begin
        begin
	        raise notice '20170911_DDL_CHRONOLOGIES_REFACTOR_MODEL has been backported to SEAD model and is now idempotent';
