...
\copy clearing_house_commit.temp_tbl_biblio (biblio_id, bugs_reference, date_updated, doi, isbn, notes, title, year, authors, full_reference, url) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/biblio.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_contacts (contact_id, address_1, address_2, location_id, email, first_name, last_name, phone_number, url, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/contact.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxonomic_order_systems (taxonomic_order_system_id, date_updated, system_description, system_name) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/taxonomic_order_system.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_alt_ref_types (alt_ref_type_id, alt_ref_type, date_updated, description) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/alt_ref_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_record_types (record_type_id, record_type_name, record_type_description, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/record_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_masters (master_set_id, contact_id, biblio_id, master_name, master_notes, url, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/dataset_master.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_locations (location_id, location_name, location_type_id, default_lat_dd, default_long_dd, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_methods (method_id, biblio_id, date_updated, description, method_abbrev_or_alt_name, method_group_id, method_name, record_type_id, unit_id) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/method.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_projects (project_id, project_type_id, project_stage_id, project_name, project_abbrev_name, description, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/project.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_datasets (dataset_id, master_set_id, data_type_id, method_id, biblio_id, updated_dataset_id, project_id, dataset_name, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/dataset.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_contacts (dataset_contact_id, contact_id, contact_type_id, dataset_id, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/dataset_contact.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_submissions (dataset_submission_id, dataset_id, submission_type_id, contact_id, date_submitted, notes, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/dataset_submission.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxa_tree_orders (order_id, date_updated, order_name, record_type_id, sort_order) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/taxa_tree_order.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxa_tree_families (family_id, date_updated, family_name, order_id) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/taxa_tree_family.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxa_tree_genera (genus_id, date_updated, family_id, genus_name) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/taxa_tree_genera.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxa_tree_master (taxon_id, author_id, date_updated, genus_id, species) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/taxa_tree_master.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxonomic_order (taxonomic_order_id, date_updated, taxon_id, taxonomic_code, taxonomic_order_system_id) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/taxonomic_order.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_value_types (value_type_id, unit_id, data_type_id, name, base_type, precision, description, value_type_uuid) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/value_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_value_classes (value_class_id, value_type_id, method_id, parent_id, name, description, value_class_uuid) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/value_classe.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_value_type_items (value_type_item_id, value_type_id, name, description) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/value_type_item.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_abundances (abundance_id, taxon_id, analysis_entity_id, abundance_element_id, abundance, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/abundance.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_analysis_entities (analysis_entity_id, physical_sample_id, dataset_id, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/analysis_entity.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_physical_samples (physical_sample_id, sample_group_id, alt_ref_type_id, sample_type_id, sample_name, date_updated, date_sampled) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/physical_sample.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_relative_dates (relative_date_id, relative_age_id, method_id, notes, date_updated, dating_uncertainty_id, analysis_entity_id) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/relative_date.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_alt_refs (sample_alt_ref_id, alt_ref, alt_ref_type_id, date_updated, physical_sample_id) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/sample_alt_ref.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_groups (sample_group_id, site_id, sampling_context_id, method_id, sample_group_name, sample_group_description, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/sample_group.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_locations (site_location_id, date_updated, location_id, site_id) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/site_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_references (site_reference_id, site_id, biblio_id, date_updated) from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_PILOT_COMMIT/site_reference.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
