...
\copy clearing_house_commit.temp_tbl_biblio from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_biblio.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_contacts from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_contact.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxonomic_order_systems from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_taxonomic_order_system.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_alt_ref_types from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_alt_ref_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_record_types from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_record_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_masters from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_dataset_master.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_locations from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_methods from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_method.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_projects from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_project.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_datasets from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_dataset.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_contacts from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_dataset_contact.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_submissions from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_dataset_submission.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxa_tree_orders from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_taxa_tree_order.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxa_tree_families from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_taxa_tree_family.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxa_tree_genera from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_taxa_tree_genera.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxa_tree_master from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_taxa_tree_master.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_taxonomic_order from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_taxonomic_order.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_value_types from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_value_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_value_classes from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_value_classe.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_value_type_items from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_value_type_item.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_abundances from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_abundance.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_analysis_entities from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_analysis_entity.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_analysis_values from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_analysis_value.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_physical_samples from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_physical_sample.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_relative_dates from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_relative_date.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_alt_refs from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_sample_alt_ref.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_groups from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_sample_group.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_locations from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_site_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_references from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_site_reference.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sites from program 'zcat -qac 20250108_DML_SUBMISSION_ADNA_001_COMMIT/submission_2_site.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');


insert into public.tbl_sites (site_id, altitude, latitude_dd, longitude_dd, national_site_identifier, site_description, site_name, site_preservation_status_id, date_updated, site_location_accuracy)
    select site_id, altitude, latitude_dd, longitude_dd, national_site_identifier, site_description, site_name, site_preservation_status_id, date_updated, site_location_accuracy
