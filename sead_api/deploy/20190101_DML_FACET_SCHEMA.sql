...
begin
    ...
    begin
       ...
       insert into facet.table (table_id, table_or_udf_name, is_udf) (values

            (1, 'tbl_horizons', FALSE),
            (2, 'tbl_aggregate_samples', FALSE),
            (3, 'tbl_analysis_entity_prep_methods', FALSE),
            (4, 'tbl_analysis_entities', FALSE),
            (5, 'tbl_dating_uncertainty', FALSE),
            (6, 'tbl_feature_types', FALSE),
            (8, 'tbl_sample_coordinates', FALSE),
            (9, 'tbl_project_stages', FALSE),
            (10, 'tbl_sample_alt_refs', FALSE),
            (11, 'tbl_activity_types', FALSE),
            (12, 'tbl_measured_value_dimensions', FALSE),
            (13, 'tbl_taxa_synonyms', FALSE),
            (14, 'tbl_colours', FALSE),
            (15, 'tbl_site_references', FALSE),
            (16, 'tbl_image_types', FALSE),
            (17, 'tbl_project_types', FALSE),
            (18, 'tbl_mcr_names', FALSE),
            (19, 'tbl_mcr_summary_data', FALSE),
            (20, 'tbl_taxa_images', FALSE),
            (21, 'tbl_taxonomic_order', FALSE),
            (22, 'tbl_imported_taxa_replacements', FALSE),
            (23, 'tbl_dendro_measurement_lookup', FALSE),
            (24, 'tbl_rdb_codes', FALSE),
            (27, 'tbl_taxa_seasonality', FALSE),
            (28, 'tbl_sample_group_description_type_sampling_contexts', FALSE),
            (29, 'tbl_contacts', FALSE),
            (30, 'tbl_sample_group_coordinates', FALSE),
            (31, 'tbl_tephras', FALSE),
            (32, 'tbl_sample_colours', FALSE),
            (33, 'tbl_method_groups', FALSE),
            (35, 'tbl_locations', FALSE),
            (36, 'tbl_taxa_tree_families', FALSE),
            (37, 'tbl_relative_age_types', FALSE),
            (38, 'tbl_abundance_elements', FALSE),
            (39, 'tbl_taxa_tree_authors', FALSE),
            (40, 'tbl_sample_group_sampling_contexts', FALSE),
            (41, 'tbl_sample_horizons', FALSE),
            (42, 'tbl_sample_group_references', FALSE),
            (43, 'tbl_taxonomic_order_systems', FALSE),
            (44, 'tbl_abundance_modifications', FALSE),
            (45, 'tbl_taxa_tree_orders', FALSE),
            (47, 'tbl_aggregate_order_types', FALSE),
            (48, 'tbl_rdb', FALSE),
            (49, 'tbl_sample_locations', FALSE),
            (50, 'tbl_abundance_ident_levels', FALSE),
            (51, 'tbl_ecocode_groups', FALSE),
            (52, 'tbl_sample_group_notes', FALSE),
            (53, 'tbl_taxonomy_notes', FALSE),
            (54, 'tbl_sample_group_description_types', FALSE),
            (55, 'tbl_relative_dates', FALSE),
            (56, 'tbl_sample_description_sample_group_contexts', FALSE),
            (58, 'tbl_projects', FALSE),
            (59, 'tbl_chron_controls', FALSE),
            (60, 'tbl_geochronology', FALSE),
            (61, 'tbl_sample_images', FALSE),
            (62, 'tbl_ecocode_definitions', FALSE),
            (63, 'tbl_taxonomic_order_biblio', FALSE),
            (64, 'tbl_site_images', FALSE),
            (65, 'tbl_sample_location_type_sampling_contexts', FALSE),
            (67, 'tbl_text_identification_keys', FALSE),
            (68, 'tbl_relative_age_refs', FALSE),
            (69, 'tbl_dendro', FALSE),
            (70, 'tbl_mcrdata_birmbeetledat', FALSE),
            (71, 'tbl_relative_ages', FALSE),
            (72, 'tbl_units', FALSE),
            (73, 'tbl_sample_description_types', FALSE),
            (74, 'tbl_years_types', FALSE),
            (75, 'tbl_features', FALSE),
            (76, 'tbl_dataset_masters', FALSE),
            (77, 'tbl_site_other_records', FALSE),
            (78, 'tbl_site_natgridrefs', FALSE),
            (79, 'tbl_languages', FALSE),
            (80, 'tbl_lithology', FALSE),
            (81, 'tbl_ceramics_measurement_lookup', FALSE),
            (82, 'tbl_seasons', FALSE),
            (83, 'tbl_dataset_contacts', FALSE),
            (84, 'tbl_biblio', FALSE),
            (85, 'tbl_dating_labs', FALSE),
            (86, 'tbl_datasets', FALSE),
            (87, 'tbl_geochron_refs', FALSE),
            (88, 'tbl_abundances', FALSE),
            (89, 'tbl_methods', FALSE),
            (90, 'tbl_text_distribution', FALSE),
            (91, 'tbl_sample_groups', FALSE),
            (92, 'tbl_location_types', FALSE),
            (93, 'tbl_analysis_entity_dimensions', FALSE),
            (94, 'tbl_sample_notes', FALSE),
            (95, 'tbl_site_preservation_status', FALSE),
            (96, 'tbl_analysis_entity_ages', FALSE),
            (97, 'tbl_ceramics_measurements', FALSE),
            (98, 'tbl_dimensions', FALSE),

            (100, 'tbl_dendro_measurements', FALSE),
            (101, 'tbl_ecocodes', FALSE),
            (102, 'tbl_physical_samples', FALSE),
            (103, 'tbl_taxa_common_names', FALSE),
            (104, 'tbl_data_type_groups', FALSE),
            (105, 'tbl_sample_types', FALSE),
            (106, 'tbl_coordinate_method_dimensions', FALSE),
            (107, 'tbl_tephra_dates', FALSE),
            (108, 'tbl_season_types', FALSE),
            (109, 'tbl_taxa_tree_master', FALSE),
            (110, 'tbl_record_types', FALSE),
            (111, 'tbl_sample_descriptions', FALSE),
            (112, 'tbl_sample_group_dimensions', FALSE),
            (113, 'tbl_site_locations', FALSE),
            (115, 'tbl_aggregate_sample_ages', FALSE),
            (116, 'tbl_sample_dimensions', FALSE),
            (117, 'tbl_chronologies', FALSE),
            (118, 'tbl_species_association_types', FALSE),
            (119, 'tbl_sites', FALSE),
            (121, 'tbl_measured_values', FALSE),
            (122, 'tbl_text_biology', FALSE),
            (123, 'tbl_contact_types', FALSE),
            (124, 'tbl_sample_group_images', FALSE),
            (126, 'tbl_taxa_measured_attributes', FALSE),
            (127, 'tbl_dendro_date_notes', FALSE),
            (128, 'tbl_ecocode_systems', FALSE),
            (129, 'tbl_tephra_refs', FALSE),
            (130, 'tbl_sample_group_descriptions', FALSE),
            (131, 'tbl_species_associations', FALSE),
            (132, 'tbl_physical_sample_features', FALSE),
            (133, 'tbl_dataset_submissions', FALSE),
            (134, 'tbl_dating_material', FALSE),
            (135, 'tbl_data_types', FALSE),
            (136, 'tbl_alt_ref_types', FALSE),
            (138, 'tbl_dendro_dates', FALSE),
            (139, 'tbl_ceramics', FALSE),
            (140, 'tbl_dataset_submission_types', FALSE),
            (141, 'tbl_taxa_reference_specimens', FALSE),
            (142, 'tbl_modification_types', FALSE),
            (143, 'tbl_rdb_systems', FALSE),
            (144, 'tbl_sample_location_types', FALSE),
            (145, 'tbl_aggregate_datasets', FALSE),
            (146, 'tbl_identification_levels', FALSE),
            (147, 'tbl_chron_control_types', FALSE),
            (148, 'tbl_taxa_tree_genera', FALSE),

            (149, 'facet.method_measured_values', TRUE),
            (150, 'facet.method_measured_values(33,0)', TRUE),
            (151, 'facet.method_measured_values(33,82)', TRUE),
            (152, 'facet.method_measured_values(32,0)', TRUE),
            (153, 'facet.method_measured_values(37,0)', TRUE),

            --(34, 'tbl_keywords', FALSE),
            --(137, 'tbl_biblio_keywords', FALSE),
            --(66, 'tbl_publishers', FALSE),
            --(120, 'tbl_collections_or_journals', FALSE),
            --(125, 'facet.tbl_denormalized_measured_values', FALSE),

            -- MISSING! (  7, 'facet.view_places_relations', FALSE),
            ( 25, 'facet.view_abundances_by_taxon_analysis_entity', FALSE),
            ( 26, 'facet.view_site_references', FALSE),
            ( 57, 'facet.view_abundance', FALSE),
            ( 99, 'facet.view_taxa_biblio', FALSE),
            (114, 'facet.view_sample_group_references', FALSE),
       ...
       insert into facet.table_relation (table_relation_id, source_table_id, target_table_id, weight, source_column_name, target_column_name) (values
			...
			(218, 102, 149, 20, 'physical_sample_id', 'physical_sample_id')
       ...
       insert into facet (facet_id, facet_code, display_title, facet_group_id, facet_type_id, category_id_expr, category_name_expr, icon_id_expr, sort_expr, is_applicable, is_default, aggregate_type, aggregate_title, aggregate_facet_id) (values
            ...
            (3, 'tbl_denormalized_measured_values_33_0', 'MS ', 5, 2, 'method_values.measured_value', 'method_values.measured_value', 'method_values.measured_value', 'method_values.measured_value', true, false, '', 'Number of samples', 1),
            (4, 'tbl_denormalized_measured_values_33_82', 'MS Heating 550', 5, 2, 'method_values.measured_value', 'method_values.measured_value', 'method_values.measured_value', 'method_values.measured_value', true, false, '', 'Number of samples', 1),
            (5, 'tbl_denormalized_measured_values_32', 'LOI', 5, 2, 'method_values.measured_value', 'method_values.measured_value', 'method_values.measured_value', 'method_values.measured_value', true, false, '', 'Number of samples', 1),
            (6, 'tbl_denormalized_measured_values_37', ' P┬░', 5, 2, 'method_values.measured_value', 'method_values.measured_value', 'method_values.measured_value', 'method_values.measured_value', true, false, '', 'Number of samples', 1),
            ...
            -- NOT USED (15, 'places_all2', 'view_places_relations', 2, 1, 'tbl_locations.location_id', 'tbl_locations.location_name', 'facet.view_places_relations.rel_id', 'tbl_locations.location_name', false, true, 'count', 'Number of samples', 1),
        ...
        insert into facet.facet_clause (facet_clause_id, facet_id, clause) (values
       ...
       insert into facet.facet_table (facet_table_id, facet_id, sequence_id, table_id, udf_call_arguments, alias) (

		   select facet_table_id, facet_id, sequence_id, t.table_id, udf_call_arguments, alias
		   from (values

				(1, 1, 1, 'tbl_analysis_entities', NULL, NULL),
				(2, 2, 1, 'tbl_datasets', NULL, NULL),

				-- (3, 3, 1, 'facet.method_measured_values', '(33, 0)', 'method_values_33'),
				-- (4, 4, 1, 'facet.method_measured_values', '(33, 82)', 'method_values_33_82'),
				-- (5, 5, 1, 'facet.method_measured_values', '(32, 0)', 'method_values_32'),
				-- (6, 6, 1, 'facet.method_measured_values', '(37, 0)', 'method_values_37'),

				(3, 3, 1, 'facet.method_measured_values(33,0)', NULL, 'method_values_33'),
				(4, 4, 1, 'facet.method_measured_values(33,82)', NULL, 'method_values_33_82'),
				(5, 5, 1, 'facet.method_measured_values(32,0)', NULL, 'method_values_32'),
				(6, 6, 1, 'facet.method_measured_values(37,0)', NULL, 'method_values_37'),

				(7, 7, 1, 'tbl_measured_values', NULL, NULL),
				(8, 8, 1, 'tbl_abundances', NULL, NULL),
				(9, 9, 1, 'tbl_sites', NULL, NULL),
				(10, 10, 1, 'tbl_geochronology', NULL, NULL),
				(11, 11, 1, 'tbl_relative_ages', NULL, NULL),
				(12, 12, 1, 'tbl_record_types', NULL, NULL),
				(13, 13, 1, 'tbl_sample_groups', NULL, NULL),
				(14, 14, 1, 'tbl_locations', NULL, NULL),
				(15, 15, 1, 'facet.view_places_relations', NULL, NULL),
				(16, 16, 1, 'tbl_sample_groups', NULL, NULL),
				(17, 17, 1, 'tbl_physical_samples', NULL, NULL),
				(18, 18, 1, 'tbl_sites', NULL, NULL),
				(19, 19, 1, 'tbl_sites', NULL, NULL),
				(20, 20, 1, 'tbl_relative_dates', NULL, NULL),
				(21, 21, 1, 'tbl_locations', NULL, 'countries'),
				(22, 22, 1, 'tbl_ecocode_definitions', NULL, NULL),
				(23, 23, 1, 'tbl_taxa_tree_families', NULL, NULL),
				(24, 24, 1, 'tbl_taxa_tree_genera', NULL, NULL),
				(25, 25, 1, 'tbl_taxa_tree_master', NULL, NULL),
				(26, 26, 1, 'tbl_taxa_tree_master', NULL, NULL),
				(27, 27, 1, 'tbl_abundances', NULL, NULL),
				(28, 28, 1, 'tbl_taxa_tree_authors', NULL, NULL),
				(29, 29, 1, 'tbl_feature_types', NULL, NULL),
				(30, 30, 1, 'tbl_ecocode_systems', NULL, NULL),
				(31, 31, 1, 'facet.view_abundance', NULL, NULL),
				(32, 32, 1, 'facet.view_abundance', NULL, NULL),
				(33, 33, 1, 'facet.view_abundance', NULL, NULL),
				(34, 34, 1, 'tbl_seasons', NULL, NULL),
				(35, 35, 1, 'facet.view_taxa_biblio', NULL, NULL),
				(36, 36, 1, 'tbl_biblio', NULL, NULL),
				(37, 37, 1, 'tbl_biblio', NULL, NULL),
				(38, 1, 2, 'tbl_physical_samples', NULL, NULL),
				(39, 14, 2, 'tbl_site_locations', NULL, NULL),
				(40, 15, 2, 'tbl_locations', NULL, NULL),
				(41, 21, 2, 'tbl_site_locations', NULL, NULL),
				(42, 22, 2, 'tbl_ecocode_definitions', NULL, NULL),
				(43, 23, 2, 'tbl_taxa_tree_families', NULL, NULL),
				(44, 24, 2, 'tbl_taxa_tree_genera', NULL, NULL),
				(45, 25, 2, 'tbl_taxa_tree_genera', NULL, NULL),
				(46, 26, 2, 'tbl_taxa_tree_genera', NULL, NULL),
				(47, 28, 2, 'tbl_taxa_tree_authors', NULL, NULL),
				(48, 29, 2, 'tbl_physical_sample_features', NULL, NULL),
				(49, 30, 2, 'tbl_ecocode_systems', NULL, NULL),
				(50, 35, 2, 'tbl_biblio', NULL, NULL),
				(51, 36, 2, 'facet.view_sample_group_references', NULL, NULL),
				(52, 37, 2, 'facet.view_site_references', NULL, NULL),
				(57, 25, 4, 'tbl_sites', NULL, NULL),
				(53, 1, 3, 'tbl_datasets', NULL, NULL),
				(54, 15, 3, 'tbl_site_locations', NULL, NULL),
				(55, 25, 3, 'tbl_taxa_tree_authors', NULL, NULL),
				(56, 26, 3, 'tbl_taxa_tree_authors', NULL, NULL)

			) as v(facet_table_id, facet_id, sequence_id, table_or_udf_name, udf_call_arguments, alias)
			join facet.table t
