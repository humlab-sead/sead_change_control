...
begin
    ...
    with ecocodes as (
      ...
      /* Return result. Note that samples are cross joined with all ecocodes
         so that all ecocodes are returned for each sample (even those with no abundanc) */
...
This function is automatically generated by fn_generate_ecocode_crosstab_function
