...
\copy clearing_house_commit.temp_tbl_dataset_submission_types from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/dataset_submission_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_location_types from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/sample_location_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dimensions from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/dimension.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_projects from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/project.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_datasets from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/dataset.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_contacts from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/dataset_contact.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_submissions from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/dataset_submission.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_analysis_entities from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/analysis_entity.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_analysis_values from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/analysis_value.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_physical_samples from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/physical_sample.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_alt_refs from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/sample_alt_ref.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_dimensions from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/sample_dimension.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_group_descriptions from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/sample_group_description.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_groups from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/sample_group.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_locations from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/sample_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_locations from program 'zcat -qac 20241213_DML_LUND_LIVING_TREES_COMMIT/site_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
