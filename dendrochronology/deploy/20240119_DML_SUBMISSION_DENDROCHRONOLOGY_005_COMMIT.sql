...
\copy clearing_house_commit.temp_tbl_projects from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_project.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_datasets from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_dataset.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_contacts from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_dataset_contact.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_submissions from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_dataset_submission.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_abundances from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_abundance.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_analysis_entities from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_analysis_entity.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dendro from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_dendro.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dendro_date_notes from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_dendro_date_note.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_physical_samples from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_physical_sample.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_alt_refs from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_sample_alt_ref.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_descriptions from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_sample_description.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_group_coordinates from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_sample_group_coordinate.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_group_descriptions from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_sample_group_description.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_group_notes from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_sample_group_note.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_groups from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_sample_group.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_locations from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_sample_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_notes from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_sample_note.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_locations from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_site_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_references from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_site_reference.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sites from program 'zcat -qac 20240119_DML_SUBMISSION_DENDROCHRONOLOGY_005_COMMIT/submission_5_site.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
