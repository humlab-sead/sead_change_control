-- Deploy dendrochronology: 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT
/***************************************************************************
Author         roger
Date
Description
...
\copy clearing_house_commit.temp_tbl_sites from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_site.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_types from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_sample_type.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_features from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_feature.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_projects from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_project.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_datasets from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_dataset.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_contacts from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_dataset_contact.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dataset_submissions from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_dataset_submission.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_groups from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_sample_group.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_physical_samples from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_physical_sample.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_analysis_entities from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_analysis_entity.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dendro from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_dendro.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dendro_dates from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_dendro_date.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_dendro_date_notes from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_dendro_date_note.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_physical_sample_features from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_physical_sample_feature.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_alt_refs from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_sample_alt_ref.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_descriptions from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_sample_description.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_group_notes from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_sample_group_note.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_locations from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_sample_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_location_type_sampling_contexts from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_sample_location_type_sampling_context.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_sample_notes from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_sample_note.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_locations from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_site_location.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_site_references from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_site_reference.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
...
\copy clearing_house_commit.temp_tbl_abundances from program 'zcat -qac 20191220_DML_SUBMISSION_DENDRO_ARCHEOLOGY_003_COMMIT/submission_3_abundance.gz' with (FORMAT text, DELIMITER E'\t', ENCODING 'utf-8');
