...
/****************************************************************************************************************
  ...
  Issue         https://github.com/humlab-sead/sead_change_control/issues/288
  Prerequisites 
  Reviewer      
  Approver      
  Idempotent    Yes
...
begin
    ...
    [
        {
            "facet_id": 55,
            "facet_code": "estimated_felling_year",
            "display_title": "Estimated Felling Year",
            "description": "Dendrochronology estimated felling year. Displays age ranges contained by selection.",
            "facet_group_id":"2",
            "facet_type_id": 4,
            ...
            "clauses":  [
                    {
                        "clause": "tbl_dendro_lookup.dendro_lookup_id = 134",
...
$facets$;
	...
	insert into facet.facet_children (facet_code, child_facet_code, position)
		...
		from facet.facet
		join (values
			('estimated_felling_year', coalesce((select max(position) + 1 from facet.facet_children where facet_code = 'dendrochronology'), 0) + 0)
