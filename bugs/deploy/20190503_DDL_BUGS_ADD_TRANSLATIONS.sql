...
begin
    ...
    begin
        ...
        -- insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'in same habitat as', 'AssociationType', 'in same habitat');
