...
begin
    ...
    begin
        ...
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'in same upland habitat', 'AssociationType', 'in same upland habitat as');
        ...
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'undefined association with', 'AssociationType', 'has undefined association with');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'inquiline', 'AssociationType', 'inquiline with');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'around nests of', 'AssociationType', 'found around nests of');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'Swarming', 'AssociationType', 'swarms with');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'is predated by', 'AssociationType', 'is predated on by');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'larvae predated by', 'AssociationType', 'larvae predated on by');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'cuckoo parasite in burrows of', 'AssociationType', 'is cuckoo parasite in burrows of');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'is kleptoparasitic in nests of', 'AssociationType', 'kleptoparasite in nest of');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'semi-parasitic with ', 'AssociationType', 'is semi-parasitic with');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'is parasite on pupae of?', 'AssociationType', 'parasitizes pupae of?');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'parasite of', 'AssociationType', 'is parasite of');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'in same habitat as', 'AssociationType', 'in smae habitat');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'pupae parasitised by', 'AssociationType', 'pupa parasitised by');
        insert into bugs_import.bugs_type_translations (bugs_table, bugs_column, triggering_column_value, target_column, replacement_value) values ('TSpeciesAssociations', 'AssociationType', 'endoparasite of pupa', 'AssociationType', 'is endoparasite of pupae of ');
