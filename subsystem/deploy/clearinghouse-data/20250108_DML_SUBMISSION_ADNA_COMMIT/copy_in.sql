...
begin
    v_submission_id := (select submission_id from clearing_house.tbl_clearinghouse_submissions where submission_name = '20250108_DML_SUBMISSION_ADNA_COMMIT' limit 1);
...
update staging_tbl_abundances
    set submission_id = (select submission_id from clearing_house.tbl_clearinghouse_submissions where submission_name = '20250108_DML_SUBMISSION_ADNA_COMMIT' limit 1);
